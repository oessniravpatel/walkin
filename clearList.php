...
$query = "SELECT * FROM `tblinterview` where (isfeedback1='Approve' or isfeedback2='Approve' or isfeedback3='Approve')";
=======
$error="";
if(isset($_REQUEST['interviewId']) and $_REQUEST['interviewId']!="")
{
...
$query = "SELECT * FROM `tblInterview` where results='clear' ";
...
<<<<<<< HEAD
                            ...
                            <td><a href="feedback.php?interviewId=<?php echo$row['interviewId']; ?>">Feedback</a>| <a href="Schedule.php?interviewId=<?php echo$row['interviewId']; ?>">Schedule</a>| <a href="rejectList.php?interviewId=<?php echo$row['interviewId']; ?>&act=reject">Reject</a>  <label> </td>
                        </tr>
    <?php
    $i++;
}
?>
=======
                            <td><a href="feedback.php?interviewId=<?php echo$row['interviewId']; ?>">Feedback</a> | <a href="rejectList.php?interviewId=<?php echo$row['interviewId']; ?>&act=reject">Reject</a> | <a href="clearList.php?interviewId=<?php echo$row['interviewId']; ?>&act=clear">Accept</a> <label> </td>
                        </tr>
                        <?php
                        $i++;
                    }
